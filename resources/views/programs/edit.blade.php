...
<div class="programs-page-container" style="max-width:1200px;margin:0 auto;">
    <div class="programs-table-card" style="background:#faf9f6;border-radius:16px;box-shadow:0 4px 24px rgba(30,41,59,0.07);padding:2.2rem 1.5rem;border-top:5px solid #d4af37;">
        <h2 class="programs-title" style="font-weight:900;color:#174032;font-size:1.5rem;letter-spacing:0.5px;font-family:'Cairo',sans-serif;text-align:center;margin-bottom:2rem;">تعديل برنامج لمسجد: {{ $masjid->name }}</h2>
        @if ($errors->any())
        ...
        @endif
    <form method="POST" action="{{ route('masjids.programs.update', [$masjid, $program]) }}" id="programForm">
        @csrf
        @method('PUT')
                    ...
                    <div class="input-icon-wrapper">
                        ...
                        <select name="program_type" id="program_type" class="form-select" required style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                            ...
                            @foreach($programTypes as $type)
                                <option value="{{ $type }}" {{ old('program_type', $program->program_type) == $type ? 'selected' : '' }}>{{ $type }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div id="common-fields">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $program->name) }}" placeholder="أدخل اسم البرنامج" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" name="status" class="form-control" value="{{ old('status', $program->status) }}" placeholder="أدخل حالة البرنامج" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" name="level" class="form-control" value="{{ old('level', $program->level) }}" placeholder="أدخل مستوى البرنامج" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="text" name="attendance_type" class="form-control" value="{{ old('attendance_type', $program->attendance_type) }}" placeholder="أدخل نوع الحضور" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
            </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            <input type="time" name="start_time" class="form-control" value="{{ old('start_time', $program->start_time) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-icon-wrapper">
                            <i class="fas fa-clock input-inside-icon"></i>
                            <input type="time" name="end_time" class="form-control" value="{{ old('end_time', $program->end_time) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                </div>
                    </div>
                </div>
                <div class="row" id="location-field">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            @foreach($locations as $location)
                                    <option value="{{ $location->id }}" data-details='@json($location->details)' {{ old('location_id', $program->location_id) == $location->id ? 'selected' : '' }}>{{ $location->name }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-icon-wrapper">
                            ...
                            @php
                                    $selectedLocation = $locations->find(old('location_id', $program->location_id));
                                $details = $selectedLocation ? $selectedLocation->details : [];
                                    $currentDetails = is_array(old('location')) ? old('location') : (array) old('location', $program->location);
                            @endphp
                            @if($details)
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        <textarea name="notes" class="form-control" rows="3" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">{{ old('notes', $program->notes) }}</textarea>
                    </div>
                </div>
            </div>
        <div id="type-fields">
                ...
                <div class="type-specific" data-type="درس علمي" style="display: none;">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="field" class="form-control" value="{{ old('field', $program->field) }}" placeholder="أدخل المجال" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">التخصص</label>
                            <input type="text" name="specialty" class="form-control" value="{{ old('specialty', $program->specialty) }}" placeholder="أدخل التخصص" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">الكتاب المستخدم</label>
                            <input type="text" name="book" class="form-control" value="{{ old('book', $program->book) }}" placeholder="أدخل اسم الكتاب" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">اسم الشيخ</label>
                            <input type="text" name="teacher" class="form-control" value="{{ old('teacher', $program->teacher) }}" placeholder="أدخل اسم الشيخ" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">رابط البث</label>
                            <input type="text" name="teacher_link" class="form-control" value="{{ old('teacher_link', $program->teacher_link) }}" placeholder="أدخل رابط البث" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                    </div>
                </div>
            </div>
            <!-- حلقة تحفيظ -->
                <div class="type-specific" data-type="حلقة تحفيظ" style="display: none;">
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="group" class="form-control" value="{{ old('group', $program->group) }}" placeholder="أدخل اسم الحلقة" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">اسم المعلم</label>
                            <input type="text" name="instructor" class="form-control" value="{{ old('instructor', $program->instructor) }}" placeholder="أدخل اسم المعلم" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">رابط البث أو الملف</label>
                            <input type="text" name="instructor_link" class="form-control" value="{{ old('instructor_link', $program->instructor_link) }}" placeholder="أدخل الرابط" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                    </div>
                </div>
            </div>
            <!-- إمامة -->
                <div class="type-specific" data-type="إمامة" style="display: none;">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="time" name="adhan_fajr" class="form-control" value="{{ old('adhan_fajr', $program->adhan_fajr) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إقامة الفجر</label>
                            <input type="time" name="iqama_fajr" class="form-control" value="{{ old('iqama_fajr', $program->iqama_fajr) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إمام الفجر</label>
                            <input type="text" name="imam_fajr" class="form-control" value="{{ old('imam_fajr', $program->imam_fajr) }}" placeholder="اسم الإمام" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">أذان الظهر</label>
                            <input type="time" name="adhan_dhuhr" class="form-control" value="{{ old('adhan_dhuhr', $program->adhan_dhuhr) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إقامة الظهر</label>
                            <input type="time" name="iqama_dhuhr" class="form-control" value="{{ old('iqama_dhuhr', $program->iqama_dhuhr) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إمام الظهر</label>
                            <input type="text" name="imam_dhuhr" class="form-control" value="{{ old('imam_dhuhr', $program->imam_dhuhr) }}" placeholder="اسم الإمام" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">أذان العصر</label>
                            <input type="time" name="adhan_asr" class="form-control" value="{{ old('adhan_asr', $program->adhan_asr) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إقامة العصر</label>
                            <input type="time" name="iqama_asr" class="form-control" value="{{ old('iqama_asr', $program->iqama_asr) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إمام العصر</label>
                            <input type="text" name="imam_asr" class="form-control" value="{{ old('imam_asr', $program->imam_asr) }}" placeholder="اسم الإمام" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">أذان المغرب</label>
                            <input type="time" name="adhan_maghrib" class="form-control" value="{{ old('adhan_maghrib', $program->adhan_maghrib) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إقامة المغرب</label>
                            <input type="time" name="iqama_maghrib" class="form-control" value="{{ old('iqama_maghrib', $program->iqama_maghrib) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إمام المغرب</label>
                            <input type="text" name="imam_maghrib" class="form-control" value="{{ old('imam_maghrib', $program->imam_maghrib) }}" placeholder="اسم الإمام" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">أذان العشاء</label>
                            <input type="time" name="adhan_isha" class="form-control" value="{{ old('adhan_isha', $program->adhan_isha) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إقامة العشاء</label>
                            <input type="time" name="iqama_isha" class="form-control" value="{{ old('iqama_isha', $program->iqama_isha) }}" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label" style="color:#174032;font-weight:700;font-family:'Cairo',sans-serif;">إمام العشاء</label>
                            <input type="text" name="imam_isha" class="form-control" value="{{ old('imam_isha', $program->imam_isha) }}" placeholder="اسم الإمام" style="border-radius:8px;border:1.5px solid #d4af37;font-family:'Cairo',sans-serif;">
                        </div>
                    </div>
                </div>
            </div>
            <div class="d-flex justify-content-center gap-3 mt-4">
                <button type="submit" class="btn btn-primary" style="border-radius:8px;background:#d4af37;color:#174032;font-weight:700;font-family:'Cairo',sans-serif;padding:0.7rem 2.1rem;font-size:1.07rem;min-width:140px;">تحديث البرنامج</button>
